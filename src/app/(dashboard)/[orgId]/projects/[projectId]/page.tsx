                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {['simple', 'ml', 'powerbi'].map((style) => {
                                // In a real app we might check if specific dashboard exists, 
                                // but for now we assume all styles are available if project is ready
                                return (
                                    <Link
                                        key={style}
                                    ...
                                    >
                                        <Button variant="outline" className="w-full h-24 flex-col">
                                            ...
                                            <span className="text-xs text-slate-500 mt-1">
                                                {style === 'simple' ? 'Lightdash' : style === 'ml' ? 'ML Plots' : 'Power BI Style'}
                                            </span>
                                        </Button>
                                    </Link>
                                );
