...
export function NeonOrbs() {
    ...
    return (
        <div className="fixed inset-0 -z-10 w-full h-screen overflow-hidden flex items-center justify-center bg-slate-100 dark:bg-[#050a18] transition-colors duration-500">
            {/* Top-left orb */}
            <div
            ...
            {/* Center text - DISABLED as it's a background component */}
            {/* 
